...
<<<<<<< HEAD
	ЭтоВстроеннаяОбработка = КонтекстЯдра.Объект.ЭтоВстроеннаяОбработка;
...
<<<<<<< HEAD
	ПостроительДереваТестов = СоздатьОбъектПлагина("ПостроительДереваТестов");
	ЗагрузчикФайла = СоздатьОбъектПлагина("ЗагрузчикФайла");
=======
...
&НаКлиентеНаСервереБезКонтекста
Функция ДополнитьИдентификаторПрефиксомПодсистемы(Знач Идентификатор, ИспользуемыйПрефиксПодсистемы)
...
КонецФункции
&НаКлиентеНаСервереБезКонтекста
Функция ПолучитьИдентификаторБезПрефиксаПодсистемы(Знач Идентификатор, ИспользуемыйПрефиксПодсистемы)
